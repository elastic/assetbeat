...
func (s *ClustersClientStub) ListClusters(
	ctx context.Context,
	...
	for _, tt := range []struct {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			listInstanceClientCreator := listInstanceAPIClient{
				AggregatedList: listInstanceClient.AggregatedList,
			}
			...
			err := collectGKEAssets(
				...
				tt.cfg,
				vpcAssetsCache,
				tt.computeAssetsCache,
				log,
				listInstanceClientCreator,
				&listClusterClient,
				publisher,
			)

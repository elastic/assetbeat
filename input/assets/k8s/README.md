...
| asset.kind                         | The kind of asset. For a kubernetes node the kind is host                                                                                                                       | `"host`                                                                          |
| asset.id                           | The metadata uid of the kubernetes node                                                                                                                                         | `"0eef8c0d-e6de-4d62-9de5-4d65ae3bfc53"`                                         |
| asset.ean                          | the EAN of this specific resource                                                                                                                                               | `"k8s.node:0eef8c0d-e6de-4d62-9de5-4d65ae3bfc53"`                                |
| asset.parents                      | The EAN of the hierarchical parent for this specific asset resource. For a K8s node, this corresponds to the EAN of the k8s.cluster it belongs to in case this information can be retrieved from CSP metadata. | `[ "k8s.cluster:3e63bba2eef749e9a120912b8a93023e1f1e545d3f6e4ad6ab14f4654a7c0ef6" ]`                                            |
...
```json
{
  ...
  "asset.type": "k8s.node",
  "asset.kind": "host",
  "asset.ean": "k8s.node:0eef8c0d-e6de-4d62-9de5-4d65ae3bfc53",
  ...
  "asset.parents": [
    "k8s.cluster:3e63bba2eef749e9a120912b8a93023e1f1e545d3f6e4ad6ab14f4654a7c0ef6"
  ]
}
```
### K8s Pods
...
| asset.kind                         | The kind of asset. For a kubernetes pod the kind is container_group                                                                                                             | `"container_group`                                                                          |
| asset.id                           | The UID of the kubernetes pod                                                                                                                                                   | `"c8809ae3-ae80-4708-8a9b-fd06f050b881"`             |
| asset.ean                          | the EAN of this specific resource                                                                                                                                               | `"k8s.pod:c8809ae3-ae80-4708-8a9b-fd06f050b881"` |
| asset.parents                      | The EAN of the hierarchical parent for this specific asset resource. For a K8s pod, this corresponds to the EAN of the node it runs on.                                         | `[ "k8s.node:33a81d8e-27e4-46cd-abd6-7577fd4d457b" ]`                                            |
...
```json
{
  ...
  "asset.ean": "k8s.pod:c8809ae3-ae80-4708-8a9b-fd06f050b881",
  "asset.parents": [
    "k8s.node:33a81d8e-27e4-46cd-abd6-7577fd4d457b"
  ],
...
| asset.kind                         | The kind of asset. For a kubernetes container the kind is container                                                                                                             | `"container`                                                                          |
| asset.id                           | The ID of the kubernetes container                                                                                                                                              | `"f7efd9256b5a6e5fbceb3bdf08e992410ef6652d30483fef3f6c57b162ced3c6"`             |
| asset.ean                          | the EAN of this specific resource                                                                                                                                               | `"k8s.container:f7efd9256b5a6e5fbceb3bdf08e992410ef6652d30483fef3f6c57b162ced3c6"` |
| asset.parents                      | The EAN of the hierarchical parent for this specific asset resource. For a container, this corresponds to the EAN of the pod it belongs to.                                     | `[ "k8s.pod:6b27726d-5c68-4d0e-86e3-2ab8344242a0" ]`                                            |
...
```json
{
  ...
  "asset.ean": "k8s.container:f7efd9256b5a6e5fbceb3bdf08e992410ef6652d30483fef3f6c57b162ced3c6",
  ...
  "asset.parents": [
    "k8s.pod:6b27726d-5c68-4d0e-86e3-2ab8344242a0"
  ],
  "ecs": {
    "version": "8.0.0"
  }
